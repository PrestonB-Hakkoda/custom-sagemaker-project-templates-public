...
from pipelines._utils import get_pipeline_driver, convert_struct, get_pipeline_custom_tags, upload_reqs
...
def main():  # pragma: no cover
    ...
    ## added section to upload req
    try:
        upload_status = upload_reqs(args.kwargs)
