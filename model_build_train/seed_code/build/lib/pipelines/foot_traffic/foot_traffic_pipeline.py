...
def _create_pipeline_steps(
    ...
    *Note that the processing code needs to line up with these paths
    ...
    data_eng_inputs_list = [
        ...
        {
            "data_eng_reqs": {
                "source": 's3://sagemaker-us-east-2-644944822023/foot_traffic_test/pipeline_requirements/01_data_eng_reqs.txt',
                "destination": "/opt/ml/processing/pipeline_reqs"
            }
        },
        {
            "feature_store_script": {
                "source": 's3://sagemaker-us-east-2-644944822023/foot_traffic_test/feature_store/create_feature_store.py',
    ...
    train_prep_inputs_list = [
        ...
        {
            "train_prep_reqs": {
                "source": 's3://sagemaker-us-east-2-644944822023/foot_traffic_test/pipeline_requirements/02_training_prep_reqs.txt',
                "destination": "/opt/ml/processing/pipeline_reqs"
            }
        },
    ]
    ...
    eval_inputs_list = [
        ...
        {
            "eval_reqs": {
                "source": 's3://sagemaker-us-east-2-644944822023/foot_traffic_test/pipeline_requirements/03_eval_reqs.txt',
                "destination": "/opt/ml/processing/pipeline_reqs"
            }
        },
    ]    
    ...
    baseline_inputs_list = [
        ...
        {
            "baseline_reqs": {
                "source": 's3://sagemaker-us-east-2-644944822023/foot_traffic_test/pipeline_requirements/04_baseline_monitor_reqs.txt',
                "destination": "/opt/ml/processing/pipeline_reqs"
            }
        },
    ]
